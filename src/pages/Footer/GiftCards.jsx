...
const GiftCards = () => {
  ...
  const handleBuy = (card) => {
    const msg = `Hi Notsro! I want to buy the "${card.name}" Gift Card worth KES ${card.value}.`;
  ...
  return (
    <div className="min-h-screen bg-notsro-black text-white pt-12 pb-20 px-6">
      <div className="container mx-auto text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6">Give the Gift of <span className="text-notsro-orange">Flavor</span>.</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {cards.map(card => (
            <div key={card.id} className="group relative rounded-2xl overflow-hidden cursor-pointer transition-transform hover:-translate-y-2" onClick={() => handleBuy(card)}>
              {/* Card Visual */}
              <div className="bg-gradient-to-br from-notsro-orange to-red-700 h-56 p-6 flex flex-col justify-between relative z-10">
                <div className="flex justify-between items-start">
                  <span className="font-serif font-bold text-2xl">NOTSRO.</span>
              ...
              {/* Price Tag */}
              <div className="bg-notsro-charcoal p-4 flex justify-between items-center border border-white/10 border-t-0 rounded-b-2xl">
                <div>
                ...
                <button className="px-4 py-2 bg-white text-notsro-black font-bold rounded-lg hover:bg-notsro-orange hover:text-white transition">
                  Buy Now
                </button>
              </div>
            </div>
