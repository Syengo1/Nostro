...
const Footer = () => {
  return (
    <footer id="locations" className="bg-notsro-black border-t border-white/10 pt-20 pb-10">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white hover:bg-notsro-orange hover:text-white transition-all">
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/50 text-sm">
              <li>
                <Link to="/menu" className="hover:text-notsro-orange transition">Full Menu</Link>
              </li>
              <li>
                <Link to="/gift-cards" className="hover:text-notsro-orange transition">Gift Cards</Link>
              </li>
              <li>
                <Link to="/careers" className="hover:text-notsro-orange transition">Careers</Link>
              </li>
              <li>
                <Link to="/privacy" className="hover:text-notsro-orange transition">Privacy Policy</Link>
              </li>
              <li>
                <Link to="/admin" className="hover:text-notsro-orange transition">Staff Access</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-6 text-white/50 text-sm">
              <li className="flex gap-3">
                <MapPin className="w-5 h-5 text-notsro-orange shrink-0" />
                <div>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/30">
          <p>© 2025 Notsro Kenya. All rights reserved.</p>
